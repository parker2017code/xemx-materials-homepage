...
- Keep the customer decision visible: what should be tested next, what can be ruled out, and what deserves deeper validation.
...
The best sentence shape is:

> We test [real material variants] to measure [property or failure mode] before [expensive validation step].
