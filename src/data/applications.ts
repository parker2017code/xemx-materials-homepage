...
export const applications: Application[] = [
  ...
  },
  {
    ...
    description:
      "High-entropy alloys, complex solid solutions, shape-memory directions, and multicomponent spaces where candidate regions are hard to guess from single samples.",
    fit: "Applies when composition changes phase, activity, hardness, electrical behavior, or magnetic response.",
  ...
  },
  {
    ...
    fit: "Applies to electrocatalyst-relevant oxides, functional nitrides, hard films, optical films, and semiconductor-adjacent layers.",
  ...
  },
  {
    ...
    fit:
      "Applies when composition, phase, resistivity, or texture need to be narrowed before device-level testing.",
  ...
  },
  {
    ...
    fit: "Applies when composition windows need to be selected before resonator-level testing.",
  ...
  },
  {
    ...
    fit: "Applies when magnetic behavior changes sharply with composition.",
  ...
  },
  {
    ...
    fit: "Applies before committing to multilayer coating designs, photonic tests, or photoelectrochemical validation.",
  ...
  },
  {
    ...
    fit: "Applies when interface or surface-layer candidates need to be narrowed before hardware or package-level reliability testing.",
